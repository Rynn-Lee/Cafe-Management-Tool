...
Проверить добавление блюд. Работает через жопу, в частности количество, возможно не обнуляется выбранное после добавления первого блюда и остается на второе